...
type Wire struct {
	...
	B *Endpoint `protobuf:"bytes,2,opt,name=b,proto3" json:"b,omitempty"`
}
...
var file_forward_proto_rawDesc = []byte{
	...
	0x6f, 0x69, 0x6e, 0x74, 0x52, 0x01, 0x61, 0x12, 0x1f, 0x0a, 0x01, 0x62, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x45, 0x6e, 0x64,
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x01, 0x62, 0x22, 0xb7, 0x01, 0x0a, 0x08, 0x45, 0x6e, 0x64,
...
var file_forward_proto_depIdxs = []int32{
	...
	2, // 2: forward.Wire.b:type_name -> forward.Endpoint
