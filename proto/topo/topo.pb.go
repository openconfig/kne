...
const (
	...
	Service_LOAD_BALANCER Service_Type = 1
	Service_NODE_PORT     Service_Type = 2
	Service_CLUSTER_IP    Service_Type = 3
)
...
func (Service_Type) EnumDescriptor() ([]byte, []int) {
	return file_topo_proto_rawDescGZIP(), []int{10, 0}
}
...
type Service struct {
	...
	// External IP assigned by the cluster load balancer. Only populated for
	// LOAD_BALANCER services; for NODE_PORT and CLUSTER_IP services it is empty,
	// as those are reached via a cluster node address and node_port, or from
	// inside the cluster via inside_ip, respectively.
	OutsideIp string `protobuf:"bytes,5,opt,name=outside_ip,json=outsideIp,proto3" json:"outside_ip,omitempty"`
	...
	// If true, KNE ensures this service is reachable over IPv6 from outside the
	// cluster. This states intent, not mechanism: on a single-stack IPv4 cluster
	// KNE satisfies it by running a host-network proxy on each node, but on a
	// dual-stack cluster it may be satisfied natively and become a no-op.
	// Only meaningful for NODE_PORT services.
	ExternalIpv6 bool `protobuf:"varint,9,opt,name=external_ipv6,json=externalIpv6,proto3" json:"external_ipv6,omitempty"`
}
...
func (x *Service) GetExternalIpv6() bool {
	if x != nil {
...
var file_topo_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xa6, 0x08, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x02, 0x38, 0x01, 0x22, 0xfe, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07,
	...
	0x58, 0x59, 0x10, 0x0f, 0x12, 0x0e, 0x0a, 0x0a, 0x43, 0x49, 0x45, 0x4e, 0x41, 0x5f, 0x53, 0x41,
	0x4f, 0x53, 0x10, 0x10, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0x60, 0x0a, 0x0e, 0x48, 0x6f,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xd2, 0x02, 0x0a, 0x07, 0x53, 0x65, 0x72,
	...
	,
	...
	0x4f, 0x50, 0x45, 0x4e, 0x43, 0x4f, 0x4e, 0x46, 0x49, 0x47, 0x10, 0x0a, 0x12, 0x0a, 0x0a, 0x06,
	0x41, 0x4c, 0x50, 0x49, 0x4e, 0x45, 0x10, 0x0b, 0x12, 0x0d, 0x0a, 0x09, 0x44, 0x52, 0x49, 0x56,
	0x45, 0x4e, 0x45, 0x54, 0x53, 0x10, 0x0c, 0x12, 0x0b, 0x0a, 0x07, 0x46, 0x4f, 0x52, 0x57, 0x41,
	0x52, 0x44, 0x10, 0x0d, 0x12, 0x14, 0x0a, 0x10, 0x49, 0x4e, 0x5f, 0x43, 0x4c, 0x55, 0x53, 0x54,
	0x45, 0x52, 0x5f, 0x50, 0x52, 0x4f, 0x58, 0x59, 0x10, 0x0e, 0x12, 0x09, 0x0a, 0x05, 0x53, 0x4f,
	0x4e, 0x49, 0x43, 0x10, 0x0f, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x49, 0x45, 0x4e, 0x41, 0x10, 0x10,
...
var file_topo_proto_goTypes = []any{
	...
	(Service_Type)(0),            // 3: topo.Service.Type
	(*Topology)(nil),             // 4: topo.Topology
	(*Node)(nil),                 // 5: topo.Node
	(*HostConstraint)(nil),       // 6: topo.HostConstraint
	(*KernelParam)(nil),          // 7: topo.KernelParam
	(*BoundedInteger)(nil),       // 8: topo.BoundedInteger
	(*Interface)(nil),            // 9: topo.Interface
	(*Link)(nil),                 // 10: topo.Link
	(*Config)(nil),               // 11: topo.Config
	(*CertificateCfg)(nil),       // 12: topo.CertificateCfg
	(*SelfSignedCertCfg)(nil),    // 13: topo.SelfSignedCertCfg
	(*Service)(nil),              // 14: topo.Service
	nil,                          // 15: topo.Node.LabelsEntry
	nil,                          // 16: topo.Node.ServicesEntry
	nil,                          // 17: topo.Node.ConstraintsEntry
	nil,                          // 18: topo.Node.InterfacesEntry
	nil,                          // 19: topo.Config.EnvEntry
	(*anypb.Any)(nil),            // 20: google.protobuf.Any
}
var file_topo_proto_depIdxs = []int32{
	5,  // 0: topo.Topology.nodes:type_name -> topo.Node
	10, // 1: topo.Topology.links:type_name -> topo.Link
	1,  // 2: topo.Node.type:type_name -> topo.Node.Type
	15, // 3: topo.Node.labels:type_name -> topo.Node.LabelsEntry
	11, // 4: topo.Node.config:type_name -> topo.Config
	16, // 5: topo.Node.services:type_name -> topo.Node.ServicesEntry
	17, // 6: topo.Node.constraints:type_name -> topo.Node.ConstraintsEntry
	0,  // 7: topo.Node.vendor:type_name -> topo.Vendor
	18, // 8: topo.Node.interfaces:type_name -> topo.Node.InterfacesEntry
	6,  // 9: topo.Node.host_constraints:type_name -> topo.HostConstraint
	7,  // 10: topo.HostConstraint.kernel_constraint:type_name -> topo.KernelParam
	8,  // 11: topo.KernelParam.bounded_integer:type_name -> topo.BoundedInteger
	2,  // 12: topo.Interface.type:type_name -> topo.Interface.InterfaceType
	19, // 13: topo.Config.env:type_name -> topo.Config.EnvEntry
	12, // 14: topo.Config.cert:type_name -> topo.CertificateCfg
	20, // 15: topo.Config.vendor_data:type_name -> google.protobuf.Any
	13, // 16: topo.CertificateCfg.self_signed:type_name -> topo.SelfSignedCertCfg
	3,  // 17: topo.Service.type:type_name -> topo.Service.Type
	14, // 18: topo.Node.ServicesEntry.value:type_name -> topo.Service
	9,  // 19: topo.Node.InterfacesEntry.value:type_name -> topo.Interface
