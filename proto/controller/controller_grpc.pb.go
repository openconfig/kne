...
func (UnimplementedTopologyManagerServer) CreateTopology(context.Context, *CreateTopologyRequest) (*CreateTopologyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTopology not implemented")
}
func (UnimplementedTopologyManagerServer) DeleteTopology(context.Context, *DeleteTopologyRequest) (*DeleteTopologyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteTopology not implemented")
}
func (UnimplementedTopologyManagerServer) ShowTopology(context.Context, *ShowTopologyRequest) (*ShowTopologyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ShowTopology not implemented")
}
...
func (UnimplementedTopologyManagerServer) ShowCluster(context.Context, *ShowClusterRequest) (*ShowClusterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ShowCluster not implemented")
}
...
func (UnimplementedTopologyManagerServer) ApplyCluster(context.Context, *ApplyClusterRequest) (*ApplyClusterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ApplyCluster not implemented")
}
...
func RegisterTopologyManagerServer(s grpc.ServiceRegistrar, srv TopologyManagerServer) {
	// If the following call panics, it indicates UnimplementedTopologyManagerServer was
