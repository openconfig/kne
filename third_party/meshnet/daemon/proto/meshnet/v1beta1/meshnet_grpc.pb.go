...
func (c *localClient) Get(ctx context.Context, in *PodQuery, opts ...grpc.CallOption) (*Pod, error) {
	...
	out := new(Pod)
	err := c.cc.Invoke(ctx, Local_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) SetAlive(ctx context.Context, in *Pod, opts ...grpc.CallOption) (*BoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, Local_SetAlive_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) SkipReverse(ctx context.Context, in *SkipQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, Local_SkipReverse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) Skip(ctx context.Context, in *SkipQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, Local_Skip_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) IsSkipped(ctx context.Context, in *SkipQuery, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, Local_IsSkipped_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) GRPCWireExists(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*WireCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Local_GRPCWireExists_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) AddGRPCWireLocal(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, Local_AddGRPCWireLocal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) RemGRPCWire(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, Local_RemGRPCWire_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localClient) GenerateNodeInterfaceName(ctx context.Context, in *GenerateNodeInterfaceNameRequest, opts ...grpc.CallOption) (*GenerateNodeInterfaceNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, Local_GenerateNodeInterfaceName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLocalServer) SkipReverse(context.Context, *SkipQuery) (*BoolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SkipReverse not implemented")
}
...
func (UnimplementedLocalServer) IsSkipped(context.Context, *SkipQuery) (*BoolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IsSkipped not implemented")
}
func (UnimplementedLocalServer) GRPCWireExists(context.Context, *WireDef) (*WireCreateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GRPCWireExists not implemented")
}
func (UnimplementedLocalServer) AddGRPCWireLocal(context.Context, *WireDef) (*BoolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGRPCWireLocal not implemented")
}
func (UnimplementedLocalServer) RemGRPCWire(context.Context, *WireDef) (*BoolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemGRPCWire not implemented")
}
func (UnimplementedLocalServer) GenerateNodeInterfaceName(context.Context, *GenerateNodeInterfaceNameRequest) (*GenerateNodeInterfaceNameResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateNodeInterfaceName not implemented")
}
...
const (
	...
	Remote_AddGRPCWiresRemoteBatch_FullMethodName = "/meshnet.v1beta1.Remote/AddGRPCWiresRemoteBatch"
...
type RemoteClient interface {
	...
	AddGRPCWiresRemoteBatch(ctx context.Context, in *WireDefBatch, opts ...grpc.CallOption) (*WireCreateResponseBatch, error)
...
func (c *remoteClient) Update(ctx context.Context, in *RemotePod, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, Remote_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteClient) AddGRPCWireRemote(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*WireCreateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WireCreateResponse)
	err := c.cc.Invoke(ctx, Remote_AddGRPCWireRemote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteClient) AddGRPCWiresRemoteBatch(ctx context.Context, in *WireDefBatch, opts ...grpc.CallOption) (*WireCreateResponseBatch, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WireCreateResponseBatch)
	err := c.cc.Invoke(ctx, Remote_AddGRPCWiresRemoteBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *remoteClient) GRPCWireDownRemote(ctx context.Context, in *WireDef, opts ...grpc.CallOption) (*WireDownResponse, error) {
	...
	err := c.cc.Invoke(ctx, Remote_GRPCWireDownRemote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RemoteServer interface {
	...
	AddGRPCWiresRemoteBatch(context.Context, *WireDefBatch) (*WireCreateResponseBatch, error)
...
func (UnimplementedRemoteServer) AddGRPCWireRemote(context.Context, *WireDef) (*WireCreateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGRPCWireRemote not implemented")
}
func (UnimplementedRemoteServer) AddGRPCWiresRemoteBatch(context.Context, *WireDefBatch) (*WireCreateResponseBatch, error) {
	return nil, status.Error(codes.Unimplemented, "method AddGRPCWiresRemoteBatch not implemented")
}
func (UnimplementedRemoteServer) GRPCWireDownRemote(context.Context, *WireDef) (*WireDownResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GRPCWireDownRemote not implemented")
}
...
func _Remote_AddGRPCWiresRemoteBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WireDefBatch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RemoteServer).AddGRPCWiresRemoteBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Remote_AddGRPCWiresRemoteBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteServer).AddGRPCWiresRemoteBatch(ctx, req.(*WireDefBatch))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Remote_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddGRPCWiresRemoteBatch",
			Handler:    _Remote_AddGRPCWiresRemoteBatch_Handler,
		},
		{
...
type WireProtocolClient interface {
	...
	SendToStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Packet, BoolResponse], error)
}
...
func (c *wireProtocolClient) SendToOnce(ctx context.Context, in *Packet, opts ...grpc.CallOption) (*BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, WireProtocol_SendToOnce_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireProtocolClient) SendToStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[Packet, BoolResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &WireProtocol_ServiceDesc.Streams[0], WireProtocol_SendToStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Packet, BoolResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type WireProtocol_SendToStreamClient = grpc.ClientStreamingClient[Packet, BoolResponse]
...
type WireProtocolServer interface {
	...
	SendToStream(grpc.ClientStreamingServer[Packet, BoolResponse]) error
	mustEmbedUnimplementedWireProtocolServer()
}

// UnimplementedWireProtocolServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedWireProtocolServer) SendToOnce(context.Context, *Packet) (*BoolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SendToOnce not implemented")
}
func (UnimplementedWireProtocolServer) SendToStream(grpc.ClientStreamingServer[Packet, BoolResponse]) error {
	return status.Error(codes.Unimplemented, "method SendToStream not implemented")
}
func (UnimplementedWireProtocolServer) mustEmbedUnimplementedWireProtocolServer() {}
func (UnimplementedWireProtocolServer) testEmbeddedByValue()                      {}
...
func RegisterWireProtocolServer(s grpc.ServiceRegistrar, srv WireProtocolServer) {
	// If the following call panics, it indicates UnimplementedWireProtocolServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _WireProtocol_SendToStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(WireProtocolServer).SendToStream(&grpc.GenericServerStream[Packet, BoolResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type WireProtocol_SendToStreamServer = grpc.ClientStreamingServer[Packet, BoolResponse]
